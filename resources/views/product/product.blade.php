...
<!--
    <div class="scred">
        ...
        <ul class="category" style=" margin-top:0">
            <li> <a href="#"> <img src="{{ asset('myhome/img/img05.jpg') }}">
                    <p>美食</p>
                </a> </li>
            <li> <a href="#"> <img src="{{ asset('myhome/img/img06.jpg') }}">
            ...
            <li> <a href="#"><img src="{{ asset('myhome/img/img12.jpg') }}" />
                    <p>商家分类</p>
                </a> </li>
        </ul>
...
<!--底部栏目-->
<menu> <a href="index.html"><i class="icon-home"></i>首页</a> <a href="member-order.html"><i class="icon-lipin"></i>疗程购</a><a href=""><i class="icon-selectmore"></i>品牌优购</a> <a href="javascript:void(0)" id="orderCart"><i class="icon-cart"><span>2</span></i>购物车</a> <a href="member.html"><i class="icon-head"></i>我的</a> </menu>
