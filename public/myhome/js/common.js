...
$(document).ready(function(){
	// 头部获取高度
	$(".main-container,#listNav,#Introheader,#commheader").css("margin-top",$("header").height());
	...
	$(document).ready(function(){
	  $("#search-input").focus(function(){
	  	$("#search-box").css({"left":".25rem","right":"3.5rem"});
	...
	PopUplayer("#list-content li a","#DetailContent","#DetailContent .button","DetailLayer")  // 药师资质
	//弹出层 End
